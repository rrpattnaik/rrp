...
document.getElementById("momentC").value = "";
...
document.getElementById("thetax1").value = "";
document.getElementById("thetax2").value = "";
document.getElementById("deltamax").value = "";
document.getElementById("deltaC").value = "";
